        ...
        <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
            <div class="d-flex mb-3 align-items-baseline border-bottom">
                <h3 class="h5 fw-700 mb-0">
                    <span
                        class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate($category->name) }}</span>
                </h3>
            </div>
            <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5"
                 ...
                 data-infinite='true'>
                 @foreach (filter_products_by_category(\App\Product::where('published', 1)->where('category_id',$category->id)->orderBy('num_of_sale', 'desc'))->limit(12)->get() as $key => $product)
