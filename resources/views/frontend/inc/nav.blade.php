        ...
        <div class="border-top border-gray-200 py-1 custom-top-color-2">
            <div class="container d-flex justify-content-between">
                ...
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    ...
                    @if($key == 0)
                    <li class="list-inline-item mx-0">
                        <a href="{{ route('search') }}" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            {{ "Book Store" }}
                        </a>
                    </li>
                    <li class="list-inline-item mx-0">
                        <a href="{{ route('orders.track') }}" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            {{ "Track Order" }}
                        </a>
                    </li>
                    <li class="list-inline-item mx-0">
                        <a href="{{ route('authors.all') }}" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            {{ "All Authors" }}
                        </a>
                    </li>
                    @endif
