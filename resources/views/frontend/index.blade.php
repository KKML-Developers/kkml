                ...
                <div class="col-lg-12">
                    ...
                    @if (count($featured_categories) > 0)
                        <div class="list-unstyled  aiz-carousel mb-0 row gutters-5" data-items="6" data-xs-items="4"
                            data-sm-items="3" data-md-items="4" data-lg-items="4" data-xl-items="5" data-arrows='false'
                            data-infinite='true'>
        ...
        <div class="mb-4">
            <div class="container">
                <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                    ...
                    <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="7" data-xl-items="5"
        ...
        <div class="mb-4">
            <div class="container">
                <div class="row gutters-10">
                    <div class="col-lg-12">
                        <div class="bg-soft-primary rounded-top p-3 d-flex align-items-center justify-content-start">
                ...
                <div class="kkml-deal bg-primary rounded-bottom py-15px px-25px">
                                ...
                                <div class="kkml-deal__inner carousel-box">
                                    <a href="{{ route('product', $product->slug) }}"
                                        ...
                                        <div
                                            ...
                                            <p class="fw-700 text-primary">{{ home_discounted_base_price($product->id) }}
                                            </p>
                                            @if (home_base_price($product->id) != home_discounted_base_price($product->id))
                                                <div class="fs-14">
                                                    <del
            ...
            <div class="container">
                <div class="row gutters-10">
                    <div class="col-lg-12">
                        <div class="bg-soft-primary rounded-top p-3 d-flex align-items-center justify-content-start">
                            <span
                                class="fw-600 fs-16 mr-2 text-truncate">{{ translate('Top 10 Authors') }}</span>
                ...
                <div class="kkml-deal bg-white rounded-bottom py-15px px-25px">
                    <div class="kkml-authors aiz-carousel gutters-10 half-outside-arrow" data-items="7" data-xl-items="5"
                        data-lg-items="4" data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'
                        data-infinite='true'>
                            ...
                            @if ($brand != null)
                                <div class="carousel-box">
                                    <a href="{{ route('products.brand', $brand->slug) }}"
                                        class=" d-block text-reset rounded"
                                        title="{{ $brand->getTranslation('name') }}" data-toggle="tooltip">
                                        ...
                                        <div class="kkml-authors__name">
                                            <p class="text-truncate-2 fs-14 fw-600">
